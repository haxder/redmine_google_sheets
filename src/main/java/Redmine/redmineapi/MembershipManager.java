...
import Redmine.redmineapi.bean.Membership;
import Redmine.redmineapi.bean.Project;
import Redmine.redmineapi.bean.Role;
...
public class MembershipManager {
    ...
    /**
     * Use {@link Redmine.redmineapi.ProjectManager#getProjectMembers(String)} instead.
     */
    @Deprecated
     ...
     */
    @Deprecated
    public List<Membership> getMemberships(int projectId) throws Redmine.redmineapi.RedmineException {
        return transport.getChildEntries(Project.class, projectId, Membership.class);
    }

    private Membership addMembership(Membership membership) throws Redmine.redmineapi.RedmineException {
    ...
    public Membership getMembership(int membershipId) throws Redmine.redmineapi.RedmineException {
     ...
     */
    @Deprecated
    public void delete(int membershipId) throws Redmine.redmineapi.RedmineException {
     ...
     */
    @Deprecated
    public void delete(Membership membership) throws Redmine.redmineapi.RedmineException {
     ...
     */
    @Deprecated
    public void update(Membership membership) throws Redmine.redmineapi.RedmineException {
     ...
     */
    @Deprecated
    public Membership createMembershipForGroup(int projectId, int itemId, Collection<Role> roles) throws Redmine.redmineapi.RedmineException {
