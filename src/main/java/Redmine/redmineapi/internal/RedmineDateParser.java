...
public final class RedmineDateParser {
     ...
     * Full date format.
     */
    public static final Redmine.redmineapi.internal.LocalDateFormat FULL_DATE_FORMAT = new Redmine.redmineapi.internal.LocalDateFormat("yyyy/MM/dd HH:mm:ss Z");

    /**
     * Full date format used by Redmine 2.
     * <p>Example: 2015-01-23T00:15:24Z
     */
    public static final Redmine.redmineapi.internal.LocalDateFormat FULL_DATE_FORMAT_V2 = new Redmine.redmineapi.internal.LocalDateFormat("yyyy-MM-dd'T'HH:mm:ssz");

    /**
     * Full date format used by Redmine 3.
     * <p>Example from redmine 3.0.0: 2015-01-29T10:06:19.000Z
     */
    public static final Redmine.redmineapi.internal.LocalDateFormat FULL_DATE_FORMAT_V3 = new Redmine.redmineapi.internal.LocalDateFormat("yyyy-MM-dd'T'HH:mm:ss.SSSz");
     ...
     */
    public static final Redmine.redmineapi.internal.LocalDateFormat SHORT_DATE_FORMAT = new Redmine.redmineapi.internal.LocalDateFormat(SHORT_DATE_PATTERN_V1);

    /**
     * Short date format for Redmine v. 2.x.
     */
    public static final Redmine.redmineapi.internal.LocalDateFormat SHORT_DATE_FORMAT_V2 = new Redmine.redmineapi.internal.LocalDateFormat(SHORT_DATE_PATTERN_V2);
