...
import Redmine.redmineapi.bean.*;
import Redmine.redmineapi.internal.json.JsonObjectWriter;
import Redmine.redmineapi.internal.json.JsonOutput;
...
//		addIfSet(writer, "name", storage, User.FULL_NAME);
	...
	public static void writeIssue(final JSONWriter writer, Issue issue) throws JSONException {
		...
		addIfSet(writer, "start_date", storage, Issue.START_DATE, Redmine.redmineapi.internal.RedmineDateParser.SHORT_DATE_FORMAT_V2.get());
		addIfSet(writer, "due_date", storage, Issue.DUE_DATE, Redmine.redmineapi.internal.RedmineDateParser.SHORT_DATE_FORMAT_V2.get());
	...
	public static void addIfSetShort2(JSONWriter writer, String jsonKeyName, PropertyStorage storage, Property<Date> property) throws JSONException {
		final SimpleDateFormat format = Redmine.redmineapi.internal.RedmineDateParser.SHORT_DATE_FORMAT_V2.get();
