...
public final class Communicators {
	...
	public static <K, V> SimpleCommunicator<V> simplify(
            Redmine.redmineapi.internal.comm.Communicator<K> communicator, ContentHandler<K, V> handler) {
	...
	public static <K, R> Redmine.redmineapi.internal.comm.Communicator<R> fmap(Communicator<K> comm,
