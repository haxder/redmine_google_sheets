 ...
 * @see Redmine.redmineapi.IssueManager
 * @see Redmine.redmineapi.UserManager
 * @see AttachmentManager
 * @see Redmine.redmineapi.ProjectManager
 */
public class RedmineManager {

    private final Transport transport;
    private final Redmine.redmineapi.IssueManager issueManager;
    private final AttachmentManager attachmentManager;
    private final Redmine.redmineapi.UserManager userManager;
    private final Redmine.redmineapi.ProjectManager projectManager;
    private final MembershipManager membershipManager;
    private final CustomFieldManager customFieldManager;
    private final Redmine.redmineapi.WikiManager wikiManager;
    private final TimeEntryManager timeEntryManager;

    RedmineManager(Transport transport) {
        this.transport = transport;
        issueManager = new Redmine.redmineapi.IssueManager(transport);
        attachmentManager = new AttachmentManager(transport);
        userManager = new Redmine.redmineapi.UserManager(transport);
        projectManager = new Redmine.redmineapi.ProjectManager(transport);
        membershipManager = new MembershipManager(transport);
        wikiManager = new Redmine.redmineapi.WikiManager(transport);
