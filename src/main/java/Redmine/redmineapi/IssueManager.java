...
import Redmine.redmineapi.internal.Joiner;
...
public class IssueManager {
     ...
     * @throws RedmineException
     */
    public Issue getIssueById(Integer id, Redmine.redmineapi.Include... include) throws RedmineException {
     ...
     * @see Issue
     */
    public List<Issue> getIssues(String projectKey, Integer queryId, Redmine.redmineapi.Include... include) throws RedmineException {
    ...
    /**
     * Delivers a list of existing {@link IssueStatus}es.
     *
     * @return a list of existing {@link IssueStatus}es.
     * @throws RedmineAuthenticationException thrown in case something went wrong while trying to login
     * @throws RedmineException        thrown in case something went wrong in Redmine
     * @throws NotFoundException       thrown in case an object can not be found
     */
    ...
    /**
     * @return a list of all {@link Tracker}s available (like "Bug", "Task", "Feature")
     * @throws RedmineAuthenticationException thrown in case something went wrong while trying to login
     * @throws RedmineException        thrown in case something went wrong in Redmine
     * @throws NotFoundException       thrown in case an object can not be found
     */
