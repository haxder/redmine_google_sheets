...
public class IssueCategory implements Identifiable, Serializable, FluentStyle {
    ...
    public final static Redmine.redmineapi.bean.Property<Integer> ASSIGNEE_ID = new Redmine.redmineapi.bean.Property<>(Integer.class, "assigneeId");
    public final static Redmine.redmineapi.bean.Property<String> ASSIGNEE_NAME = new Property<>(String.class, "assigneeName");
    ...
    /**
     * creates a new {@link IssueCategory} for the {@link Redmine.redmineapi.bean.Project} contained. <br>
     * Pre-condition: the attribute {@link Redmine.redmineapi.bean.Project} for the {@link IssueCategory} must
     * not be null!
     *
