...
public class TimeEntry implements Identifiable, FluentStyle {
     ...
     */
    public final static Redmine.redmineapi.bean.Property<Integer> PROJECT_ID = new Redmine.redmineapi.bean.Property<>(Integer.class, "projectId");

    public final static Redmine.redmineapi.bean.Property<String> PROJECT_NAME = new Redmine.redmineapi.bean.Property<>(String.class, "projectName");
    ...
    public final static Redmine.redmineapi.bean.Property<String> ACTIVITY_NAME = new Redmine.redmineapi.bean.Property<>(String.class, "activityName");
    public final static Redmine.redmineapi.bean.Property<Integer> ACTIVITY_ID = new Redmine.redmineapi.bean.Property<>(Integer.class, "activityId");
    public final static Redmine.redmineapi.bean.Property<Float> HOURS = new Redmine.redmineapi.bean.Property<>(Float.class, "hours");
    public final static Redmine.redmineapi.bean.Property<String> COMMENT = new Redmine.redmineapi.bean.Property<>(String.class, "comment");
    public final static Redmine.redmineapi.bean.Property<Date> SPENT_ON = new Redmine.redmineapi.bean.Property<>(Date.class, "spentOn");
    ...
    public final static Redmine.redmineapi.bean.Property<Date> UPDATED_ON = new Redmine.redmineapi.bean.Property<>(Date.class, "updatedOn");
    public static final Redmine.redmineapi.bean.Property<Set<CustomField>> CUSTOM_FIELDS = new Property(Set.class, "custom_fields");
