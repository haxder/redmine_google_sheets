...
public class Version implements Identifiable, FluentStyle {
    ...
    /**
     * creates a new {@link Redmine.redmineapi.bean.Version} for the {@link Redmine.redmineapi.bean.Project} contained. <br>
     * Pre-condition: attribute projectId must be set.
     *
     * @return the new {@link Redmine.redmineapi.bean.Version} created by Redmine
    ...
    public Version create() throws RedmineException {
        ...
        return transport.addChildEntry(Redmine.redmineapi.bean.Project.class, getProjectId().toString(), this);
    }
