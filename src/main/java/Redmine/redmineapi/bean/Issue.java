...
import Redmine.redmineapi.IssueManager;
...
public class Issue implements Identifiable, FluentStyle {
  ...
  /**
    ...
    public  String getCustomFieldValuesById (int customFieldId) {
        CustomField field = getCustomFieldById(customFieldId);
