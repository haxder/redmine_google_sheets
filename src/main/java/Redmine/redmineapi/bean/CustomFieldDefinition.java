...
public class CustomFieldDefinition {
    ...
    private final List<Redmine.redmineapi.bean.Tracker> trackers = new ArrayList<Tracker>();
    private final List<Redmine.redmineapi.bean.Role> roles = new ArrayList<Role>();
